...
Signal: Changes to signal handling, agent turns, tools, provider calls, or prompt building must be verified end-to-end with the `signal-e2e-test` skill — unit tests alone are not sufficient
